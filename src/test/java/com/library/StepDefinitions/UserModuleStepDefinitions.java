...
public class UserModuleStepDefinitions {
    ...
    public void user_enters_password_and_clicks_the_enter_button() throws InterruptedException {
    ...
    public void userFillsOutFullname(String arg0) throws InterruptedException {
    ...
    public void userShouldSeeSavedUser() throws InterruptedException {

        Thread.sleep(2000);
        String actual = Driver.getDriver().findElement(By.xpath("//tr[1]//td[3]")).getText();

        String expected = "Ali Mahir";
    ...
    public void userClicksUserGroupDropdown() {
        ...
        userGroupDropDown.selectByValue("2");
